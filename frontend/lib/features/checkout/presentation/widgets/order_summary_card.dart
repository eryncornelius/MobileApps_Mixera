...
class OrderSummaryCard extends StatelessWidget {
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          if (discountTotal > 0) ...[
            const SizedBox(height: 8),
            _row('Discount', '-${_fmt(discountTotal)}', valueColor: AppColors.success),
          ],
  ...
  Widget _row(String label, String value,
      {TextStyle? labelStyle, TextStyle? valueStyle, Color? valueColor}) {
    return Row(
        ...
        Text(value,
            style: valueStyle ??
                AppTextStyles.description
                    .copyWith(color: valueColor ?? AppColors.primaryText)),
      ],
    );
  }
}
